...
<html lang="en">
  ...
  <head>
    ...
    <title>Cozy Corner Eatery - We Welcome taste</title>
<!--
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="assets/images/logo1.jpg" class="logodesign" align="klassy cafe html template" style="float:left">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li class="submenu"><a href="">Login</a>
                               <ul>
                                 <li class="scroll-to-section"><a href="login">User Login</a></li>
                                 <li class="scroll-to-section"><a href="admin">Admin Login</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            <h4>Cozy Corner Eatry</h4>
                            <h6>We serve Taste</h6>
                    ...
                    <div class="contact-form">
                        <form id="contact" action="/home" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-12">
                              <fieldset>
                                <input type="text" name="message" rows="6" id="message" placeholder="Message" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                              <fieldset>
